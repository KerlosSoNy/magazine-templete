const SOCIALS = [
    {
        icon:
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.75 12.25L6.15323 7.84677M7.84677 6.15323L12.25 12.25H9.33333L6.15323 7.84677L1.75 1.75H4.66667L7.84677 6.15323ZM12.25 1.75L7.84677 6.15323" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
...
export default function FollowUs() {
    return (
        <div className="absolute top-1/2 -translate-y-1/2 inset-s-40 z-30 flex flex-col items-center gap-4">

...
export default function StandFor() {
    return (
        <div className="w-screen flex flex-col items-center py-24 bg-white">
            <span className="text-1 font-bold text-text-secondary">We <span className="text-main">Stand</span> For</span>
            <div className="grid grid-cols-3 gap-10 container mt-10">
                ...
                <div className="flex flex-col gap-18.75 pt-18.75">
                    <Image
                        src="/images/about/map.png"
                        alt='Map Stands'
                        width={455.5}
                        height={325.51}
                        className="w-[455.5px] h-[325.51px]"
                    />

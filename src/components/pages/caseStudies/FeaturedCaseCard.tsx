    ...
    return (
        <div className="w-full flex flex-col lg:flex-row gap-6 lg:gap-10 items-stretch border-t border-text-disabled pt-4 lg:pt-16">
            ...
            <div className="flex flex-col items-start justify-center gap-6 w-full lg:flex-1">
                <CaseStudyPills tags={[year, category]} />
                ...
                <div className="flex flex-col gap-1 -mt-4">
                    <span className="text-4 xl:text-3 font-bold text-text-secondary">{item.subTitle}</span>
                    <p className="text-6 xl:text-5 text-text-placeholder max-w-150">{item.description}</p>
                </div>

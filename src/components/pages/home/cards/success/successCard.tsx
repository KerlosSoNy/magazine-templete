...
export default function SuccessCard() {
    return (
        <div className="flex flex-row h-107 p-4 items-center gap-16 me-12.5">
            <Image
                alt="success card"
                src="/images/home/sucessImage.png"
                width={107}
                height={107}
                className="w-164.75 h-95 rounded-xl object-cover"
            />
            <div className="flex flex-col max-w-124 items-start">
                ...
                <span className="text-5 text-text-placeholder leading-5 mt-5">
                ...
                <h1 className="font-bold text-3 text-text-secondary mt-5">Khaled Sharif</h1>

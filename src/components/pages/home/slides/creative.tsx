        ...
        <div className="w-screen h-fit py-10 md:py-0 md:h-screen overflow-hidden md:mt-10 flex items-center justify-center relative" data-nav-bg="white">
            ...
            <div className="relative z-2 w-full container grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-16 px-10">
                <motion.h2
                    ...
                    className="font-bold text-4 lg:text-2 3xl:text-1 leading-4 lg:leading-2 3xl:leading-1 text-black self-start">
                ...
                <motion.p
                    ...
                    className="text-text-placeholder text-[12px] lg:text-7 3xl:text-5 leading-7 3xl:leading-5 self-start">
                    {t("paragraph1")}
                </motion.p>
                <motion.p
                    initial={{ opacity: 0, x: -40 }}
                    ...
                    className="text-text-placeholder text-[12px] lg:text-7 3xl:text-5 leading-7 3xl:leading-5 self-end">
                    {t("paragraph2")}
                </motion.p>
                <motion.h2
                    initial={{ opacity: 0, x: -40 }}
                    ...
                    className="font-bold text-4 lg:text-2 3xl:text-1 leading-4 lg:leading-2 3xl:leading-1 text-black text-start md:mx-auto self-start md:self-center">

...
export default function Creative() {
    return (
        <div className="w-screen h-screen overflow-hidden mt-10 flex items-center justify-center relative" data-nav-bg="white">
            <Image
                alt="Success Background"
                src="/images/home/bigLogo.png"
                width={854}
                height={767}
                className="absolute top-1/2 opacity-[0.05] mix-blend-luminosity aspect-108/97 -translate-y-1/2 left-1/2 -translate-x-1/2 w-213.5 h-191.75"
            />
            <div className="relative z-2 w-full max-w-355.5 grid grid-cols-2 gap-x-20 gap-y-16 px-10">
                <h1 className="font-bold text-1 leading-1 text-black self-start">
                    Creating Value Begins With <span className="text-main">Understanding</span>
                </h1>
                <p className="text-text-placeholder text-5 leading-5 self-start">
                ...
                <p className="text-text-placeholder text-5 leading-5 self-end">
                ...
                <h1 className="font-bold text-1 leading-1 text-black text-start mx-auto self-center">
                    Global Reach <br /> <span className="text-main">Local Expertise</span>
                </h1>
            </div>
        </div>
    )

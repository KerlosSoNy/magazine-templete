                ...
                <div className="flex max-w-145 flex-col text-start">
                    ...
                    <Link href={'/'} type="submit" className={` rounded-lg bg-[#E8EEED] h-12 w-fit px-8 flex items-center justify-center gap-1.5`}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M19 15V17C19 18.1046 18.1046 19 17 19H7C5.89543 19 5 18.1046 5 17V15M12 5V15M14 13L12 15L10 13" stroke="#145048" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>

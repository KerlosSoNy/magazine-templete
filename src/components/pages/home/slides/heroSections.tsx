        ...
        <div data-nav-bg="black" className="w-screen h-screen max-w-screen max-h-screen overflow-hidden flex items-center justify-center relative">
            ...
            <div className="flex flex-col items-center relative z-5">
                <div className="flex flex-row items-center gap-3">
                    <span className="text-white text-6 md:text-5">Part of:</span>
                    <Image
                ...
                <span className="text-5 md:text-3 text-white my-3 xl:my-7">Your Partner in Value Creation</span>
                <h1 className="max-w-175 xl:max-w-[1033.5px] text-3 md:text-2 xl:text-1 mb-7 font-bold text-center leading-2 xl:leading-1 text-white">Transforming Businesses with Innovative, Sustainable Solutions</h1>

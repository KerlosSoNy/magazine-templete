    ...
    return (
        <div className="w-screen h-fit py-10 md:py-0 md:h-screen overflow-hidden flex items-center justify-center" data-nav-bg="white">
            <div className="flex flex-col items-center text-center">
                <span className="text-7 3xl:text-5 text-text-placeholder">Our Case studies</span>
                <h1 className="text-2 3xl:text-1 font-bold leading-2 3xl:leading-1 text-black mt-6 max-w-140 lg:max-w-180 3xl:max-w-243.25">

    ...
    return (
        <div data-nav-bg="black" className="w-screen flex items-center justify-center py-10 md:py-0 h-fit md:h-screen bg-main relative max-w-full max-h-full overflow-hidden">
            ...
            <div className="flex flex-col w-full items-center text-center z-2">
                <h1 className="max-w-150 text-3 3xl:text-1 font-bold leading-1 text-white">Our value creation services</h1>
                <p className="max-w-128.75 text-6 3xl:text-5 text-white 3xl:mt-5 leading-6 3xl:leading-5">Explore our meticulously-tailored solutions and our four principal areas of focus, designed to meet the unique needs of your business</p>
                <DiscoverCards />
            </div>
        </div>
    )

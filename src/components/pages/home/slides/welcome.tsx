...
export default function Welcome() {
    return (
        <div data-nav-bg="white" className="w-screen h-screen flex items-center justify-center">
            <div className="flex flex-row items-center gap-15">
                <Image
                    ...
                    loading="eager"
                />
                <div className="flex flex-col items-start max-w-192.5">
                    <h1 className="font-bold text-1 leading-18 text-main">
                        <span className="text-black">Welcome to </span>
                        <br />
                        Minds Advisory by AMG
                    </h1>
                    <span className="text-text-placeholder mt-4 text-justify text-5">
                    ...
                    <span className="text-text-placeholder mt-4 text-justify text-5">
                        With a team of seasoned professionals boasting extensive experience across the GCC, North Africa, and Europe, we offer bespoke solutions that address internal inefficiencies and unlock the latent potential within your organization
                    </span>
                    <span className="text-text-placeholder mt-4 text-justify text-5">
                        Whether you are looking to optimize your operations, execute transformative strategies, or harness the power of data, we are here to guide you every step of the way
                    </span>
                    <div className="flex flex-row items-center mt-6 gap-4">
                        ...
                        <span className="text-5 font-inter text-text-secondary">
                            Discover the Minds Advisory Story
                        </span>
                    </div>
                    <div className="flex flex-row items-center mb-8 mt-6 gap-7">
